...
/* harmony import */ var _asset_pairs_asset_list_asset_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./asset-pairs/asset-list/asset-list.component */ "./src/app/asset-pairs/asset-list/asset-list.component.ts");
...
/* harmony import */ var _asset_pairs_asset_pairs_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./asset-pairs/asset-pairs.service */ "./src/app/asset-pairs/asset-pairs.service.ts");
...
/* harmony import */ var _asset_pairs_asset_detail_asset_detail_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./asset-pairs/asset-detail/asset-detail.component */ "./src/app/asset-pairs/asset-detail/asset-detail.component.ts");
/* harmony import */ var _asset_pairs_asset_edit_asset_edit_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./asset-pairs/asset-edit/asset-edit.component */ "./src/app/asset-pairs/asset-edit/asset-edit.component.ts");
...
var appRoutes = [
    { path: 'detail', component: _asset_pairs_asset_detail_asset_detail_component__WEBPACK_IMPORTED_MODULE_11__["AssetDetailComponent"] }
];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _asset_pairs_asset_list_asset_list_component__WEBPACK_IMPORTED_MODULE_7__["AssetListComponent"],
                ...
                _asset_pairs_asset_detail_asset_detail_component__WEBPACK_IMPORTED_MODULE_11__["AssetDetailComponent"],
                _asset_pairs_asset_edit_asset_edit_component__WEBPACK_IMPORTED_MODULE_12__["AssetEditComponent"]
            ],
            imports: [
            ...
            providers: [_asset_pairs_asset_pairs_service__WEBPACK_IMPORTED_MODULE_9__["AssetPairsService"]],
...
module.exports = "<div class=\"row mt-5\">\r\n  <div class=\"col-xs-12\">\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-xs-12\">\r\n          <label for=\"indicatorList\">Select an Indicator:</label>\r\n          <select id=\"indicatorList\" class=\"form-control\">\r\n            <option selected=\"selected\">--Select--</option>\r\n            <option>EMA Cross</option>\r\n            <option>MA Cross</option>\r\n            <option>MACD</option>\r\n            <option>Abnormal Volume</option>\r\n            <option>Inside Bar Break</option>\r\n            <option>RSI</option>\r\n          </select>\r\n        </div>\r\n      </div>\r\n      <div class=\"row\">\r\n        <div class=\"col-xs-12\">\r\n          <div class=\"form-group\">\r\n            <div>RSI</div>\r\n            <label for=\"rsi4hr\"></label>\r\n            <input type=\"checkbox\" id=\"rsi4hr\" class=\"form-control\" />\r\n          </div>\r\n\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </div>\r\n</div>\r\n"
...
module.exports = "div.list-group{\r\n  max-height: 200px;\r\n  margin-bottom: 10px;\r\n  overflow-y:scroll;\r\n}\r\n\r\nbutton.list-group-item{\r\n  height: 40px;\r\n}\r\n\r\n.list-group-item {\r\n  padding: 1.50rem 1.25rem;\r\n}\r\n\r\n#trackedList{\r\n  height:auto;\r\n  overflow:visible\r\n}\r\n\r\nul.nav.nav-tabs:hover{\r\n  cursor: pointer;\r\n}\r\n\r\n\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AssetListComponent = /** @class */ (function () {
    ...
    AssetListComponent.prototype.ngOnInit = function () {
        ...
        this.assetPairsService
            ...
            _this.filteredList = _this.assetList.map(function (x) { return x.baseName; });
            //for (let item of this.assetList) {
            //  this.filteredList.push(item.baseName);
            //}
        });
    };
    AssetListComponent.prototype.addToTrack = function (event) {
    ...
    AssetListComponent.prototype.onSelect = function (index) {
...
/* harmony import */ var _asset_pair_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./asset-pair.model */ "./src/app/asset-pairs/asset-pair.model.ts");
    ...
    AssetPairsService.prototype.getAssetPairs = function () {
        return this.httpClient.get('/api/binancepairs', {
            ...
            for (var _i = 0, response_1 = response; _i < response_1.length; _i++) {
                ...
                assetList.push(new _asset_pair_model__WEBPACK_IMPORTED_MODULE_4__["AssetPair"](String(item).split("BTC")[0], 'BTC'));
            }
            return assetList;
        }));
    };
